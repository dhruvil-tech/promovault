...
//     { code: 'SAVE20', type: 'percent', value: 20, minOrder: 500, description: '20% off on orders above ₹500', expiryDate: '2026-06-30', usageLimit: 100, usedCount: 42, isActive: true, createdBy: manager._id },
//     { code: 'FLAT100', type: 'flat', value: 100, minOrder: 800, description: '₹100 flat discount above ₹800', expiryDate: '2024-04-15', usageLimit: 50, usedCount: 50, isActive: false, createdBy: manager._id },
//     { code: 'WELCOME10', type: 'percent', value: 10, minOrder: 0, description: '10% off for new customers', expiryDate: '2026-12-31', usageLimit: 500, usedCount: 188, isActive: true, createdBy: manager._id },
//     { code: 'BIGBUY30', type: 'percent', value: 30, minOrder: 1500, description: '30% off on orders above ₹1500', expiryDate: '2026-05-01', usageLimit: 30, usedCount: 12, isActive: true, createdBy: admin._id },
//   ]);
